            ...
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => FlutterFlowChoiceChips(
                  options: [
                    ChipData('Thermodynamics'),
                    ChipData('Computer Architecture'),
                    ChipData('Assembly Language'),
                    ChipData('Microbiology'),
                    ChipData('Basic Electronics'),
                    ChipData('Statistics'),
                    ChipData('Structure Development'),
                    ChipData('Engineering Mathematics')
                  ],
                  onChanged: (val) =>
                  ...
                  controller: _model.choiceChipsValueController ??=
                    ...
                    (currentUserDocument?.interest?.toList() ?? []),
                  ),
                  wrapped: true,
                ),
              ),
                  ...
                  onPressed: () async {
                    await currentUserReference!.update({
                      ...createUsersRecordData(
                        ...
                        faculty: _model.cityTextController1.text,
                        dept: _model.cityTextController2.text,
                        level: _model.cityTextController3.text,
                      ),
                      ...mapToFirestore(
                        {
                          'interest': _model.choiceChipsValues,
                        },
                      ),
                    });
